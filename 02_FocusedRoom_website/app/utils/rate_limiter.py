...
class RateLimiter:
    ...
    def is_allowed(
        self, ip_address: str, limit: Optional[int] = None, window: Optional[int] = None
    ) -> bool:
        """
    ...
    def get_reset_time(self, ip_address: str, window: Optional[int] = None) -> int:
        """
...
def rate_limit(limit: int = 10, window: int = 3600, per: str = "ip"):
    """
