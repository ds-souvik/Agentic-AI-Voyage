    ...
    def test_invalid_email_addresses(self):
        ...
        for email, expected_error in invalid_emails:
            ...
            assert expected_error in str(
                error
            ), f"Expected error '{expected_error}' not found in '{error}'"
...
class TestSubscriptionEndpoint:
    ...
    def test_subscription_invalid_email(self):
        ...
        with self.app.app_context():
            response = self.client.post(
                "/api/subscribe", json={"email": "invalid-email"}, content_type="application/json"
            )
    ...
    def test_subscription_missing_email(self):
        ...
        with self.app.app_context():
            response = self.client.post("/api/subscribe", json={}, content_type="application/json")
    ...
    def test_subscription_suspicious_fields(self):
        ...
        with self.app.app_context():
            response = self.client.post(
                "/api/subscribe",
                json={"email": "test@test.com", "website": "spam.com"},
                content_type="application/json",
            )
    ...
    def test_full_subscription_flow(self):
        ...
        with app.app_context():
            ...
            with patch("app.routes.send_subscription_confirmation") as mock_email:
                mock_email.return_value = {"success": True, "provider": "console"}
